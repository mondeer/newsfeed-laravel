...
<head>
  ...
  tinymce.init({
        ...
        toolbar: "insertfile undo redo | fontselect fontsizeselect | styleselect | bold italic | alignleft aligncenter alignright alignjustify | blockquote subscript superscript | bullist numlist outdent indent | link image",
        content_css: [
...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="index.html"><img src="/dash/assets/img/logo-dark.png" alt="Klorofil Logo" class="img-responsive logo"></a>
			</div>
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="assets/img/user.png" class="img-circle" alt="Avatar"> <span>{{ Auth::user()->first_name}}</span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="/newblog" class=""><i class="lnr lnr-code"></i> <span>New Post</span></a></li>
						<li><a href="#" class=""><i class="lnr lnr-chart-bars"></i> <span>View Posts</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
	...
	<script src="/dash/assets/vendor/jquery.easy-pie-chart/jquery.easypiechart.min.js"></script>
	<script src="/dash/assets/vendor/chartist/js/chartist.min.js"></script>
